...
function Sports() {
  ...
  return (
    <div style={{ padding: "40px", fontFamily: "'Inter', sans-serif", background: "#f1f5f9", minHeight: "100vh" }}>
      ...
      <h1 style={{ color: "#1e293b", marginBottom: "20px" }}>Sports Management</h1>
      ...
      <div style={{ background: "#ffffff", padding: "30px", borderRadius: "16px", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.05)", textAlign: "center" }}>
        ...
        />
        <h3 style={{ color: "#334155" }}>College Sports Events & Gallery</h3>
        <p style={{ color: "#64748b" }}>Yaha aap sports ki details aur photos add kar sakte hain.</p>
      </div>
    </div>
  );
}
