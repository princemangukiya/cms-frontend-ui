  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Modern Purple-Indigo Gradient Header */}
        <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ padding: "32px" }}>
          <div style={{
            ...
            {renderInputField("Subject Name", "subjectName", "Enter Subject Name", FaBook, "text", true)}
            {renderInputField("Subject Code", "subjectCode", "Enter Subject Code", FaBarcode, "text", true)}
            {renderInputField("Subject Credit", "subjectCredit", "Enter Credits (e.g. 3)", FaAward, "number", true)}
            {renderInputField("Subject Type", "subjectType", "e.g. Theory / Practical", FaLayerGroup, "text", true, ["Theory", "Practical", "Elective", "Mandatory"])}
            {renderInputField("Course ID", "courseId", "Enter Course ID", FaGraduationCap, "number", true)}
            {renderInputField("Exam ID", "examId", "Enter Exam ID", FaFileAlt, "number", true)}
          </div>
