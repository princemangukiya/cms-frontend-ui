      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ padding: "32px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
            {renderInputField("Company ID", "company_id", "Enter Company ID", FaBuilding, "number", true)}
            {renderInputField("Student ID", "student_id", "Enter Student ID", FaUserGraduate, "number", true)}
