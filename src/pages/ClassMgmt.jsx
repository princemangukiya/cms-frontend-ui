      ...
      <div style={{
        ...
        <form onSubmit={handleSave} style={{ padding: "32px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
            {renderInputField("Class Name", "class_name", "Enter Class Name", FaChalkboardTeacher, "text", true)}
            {renderInputField("Course ID", "course_id", "Enter Course ID", FaGraduationCap, "number", true)}
            {renderInputField("Building No", "building_no", "Enter Building No", FaBuilding, "text", true)}
            {renderInputField("Floor No", "floor_no", "Enter Floor No", FaLayerGroup, "text", true)}

            <div style={{ gridColumn: "span 2" }}>
              {renderInputField("Room No", "room_no", "Enter Room No", FaDoorClosed, "text", true)}
            </div>
          </div>
          ...
          <div style={{
            ...
            <button
              ...
              onMouseOver={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 12px 24px rgba(13, 148, 136, 0.45)";
              }}
              onMouseOut={(e) => {
