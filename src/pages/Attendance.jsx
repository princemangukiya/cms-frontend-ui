      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ padding: "32px" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
            {renderInputField("User ID", "userid", "Enter User ID", FaIdBadge, "number", true)}
            {renderInputField("Attendance Date", "attendancedate", "", FaCalendarAlt, "date", true)}
            {renderInputField("In Time", "intime", "", FaSignInAlt, "time", true)}
            {renderInputField("Out Time", "outtime", "", FaSignOutAlt, "time", true)}
          </div>
          ...
          <div style={{
            ...
            <button
              ...
              onMouseOver={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 12px 24px rgba(14, 165, 233, 0.45)";
              }}
              onMouseOut={(e) => {
